...
- Snap package build workflow and snapcraft configuration.
- Flatpak CI workflow, manifest, and publish gates.
- JavaScript and TypeScript analysis to the CodeQL workflow matrix.
- Pyright, ty, and ESLint to the QA tooling.
- Additional tests for `tests/test_create_lib` to improve coverage.

### Changed

- Refreshed project tooling and updated utilities to satisfy stricter Ruff rules.
- Removed trailing commas across the project.
- Updated dependencies, including Anyio, Handlebars, Requests, Tar, and various development
  packages.

### Fixed

- Yarn cache `restore-keys` template in workflows.
...
[unreleased]: https://github.com/Tatsh/clem2itunes/compare/v0.1.4...HEAD
[0.1.4]: https://github.com/Tatsh/clem2itunes/compare/v0.1.3...v0.1.4
[0.1.3]: https://github.com/Tatsh/clem2itunes/compare/v0.1.2...v0.1.3
