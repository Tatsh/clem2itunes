...
html_theme_options = {
    ...
    'repo_name': 'clem2itunes',
    'repo_url': 'https://github.com/Tatsh/clem2itunes',
    'site_url': 'https://clem2itunes.readthedocs.org',
...
intersphinx_mapping = {
    ...
    'click-aliases': ('https://click-aliases.readthedocs.io/en/latest/', None),
