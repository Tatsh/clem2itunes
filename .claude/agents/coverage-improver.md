...
1. Run `uv run pytest --cov clem2itunes --cov-branch --cov-report term-missing:skip-covered`
...
4. Run `uv run pytest --cov clem2itunes --cov-branch --cov-report term-missing:skip-covered`
